"""Solve MPO with a PE model and collecting data querying randomly a simulator."""
...
dataset = BootstrapExperienceReplay(
    max_len=int(1e4), transformations=transformations, num_bootstraps=ensemble_size
)
